...
CIFAR100_CATEGORIES_CN = (
    '猩猩', '鳟鱼', '臭鼬', '蜘蛛', '椅子', '坦克', '键盘', '男人', '鲸鱼', '龙虾', '屋子', '甲虫',
    '熊', '尖嘴小鼠', '瓶子', '杯子', '公共汽车', '橙子橘子', '大海', '橡树', '床', '郁金香', '兔子',
    '摩天大楼', '苹果', '枫树', '松树', '蜗牛', '梨', '桥', '火车', '山', '毛毛虫', '鳄鱼', '蛇',
    '袋鼠', '海豚', '牛', '浣熊', '蘑菇', '仓鼠', '碗', '台灯', '火箭', '皮卡车', '狼', '蠕虫', '水獭',
    '向日葵', '猎豹', '鳐鱼', '割草机', '摩托车', '小男孩', '狐狸', '棕榈树', '白云', '恐龙', '乌龟',
    '森林', '沙发', '罂粟', '玫瑰', '蜜蜂', '小女孩', '钟', '易拉罐', '桌子', '公路', '兰花', '电车',
    '松鼠', '螃蟹', '蝴蝶', '拖拉机', '河狸', '柳树', '骆驼', '田野', '老鼠', '大象', '比目鱼', '甜椒',
    '盘子', '电视', '水族馆鱼', '衣柜', '海豹', '蜥蜴', '蟑螂', '豪猪', '女人', '负鼠', '婴儿', '老虎',
    '电话', '鲨鱼', '狮子', '城堡', '自行车')
