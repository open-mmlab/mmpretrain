...
| :-----------------------: | :-------: | :------: | :-------: | :-------: | :-----------------------------------------------: | :-----------------------------------------------------------------------------------------: |
|     MobileNetV3-Small     |   2.54    |   0.06   |   66.68   |   86.74   |   [config](./mobilenet-v3-small_8xb128_in1k.py)   |                                          \[model\]                                          |
|     MobileNetV3-Large     |   5.48    |   0.23   |   73.49   |   91.31   |   [config](./mobilenet-v3-large_8xb128_in1k.py)   |                                          \[model\]                                          |
...
| MobileNetV3-Small-075\*\* |   2.04    |   0.04   |   65.23   |   85.44   | [config](./mobilenet-v3-small-075_8xb128_in1k.py) |                                          \[model\]                                          |
| MobileNetV3-Small-050\*\* |   1.59    |   0.02   |   57.91   |   80.19   | [config](./mobilenet-v3-small-050_8xb128_in1k.py) |                                          \[model\]                                          |
...
The preformances provided by torchvision cannot be reproduced using the exact [training recipt](https://pytorch.org/blog/ml-models-torchvision-v0.9/#classification). The Top-1 accuracy reseults are 65.5±0.5% and 73.39% for small and large model respectively. Here we provide our training results that outperform the aforementioned results.
