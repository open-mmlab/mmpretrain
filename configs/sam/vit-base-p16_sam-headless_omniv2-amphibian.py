...
train_dataloader = dict(batch_size=512,     
    dataset=dict(
        ...
        ann_file='annotation/amphibian/meta/train.txt',
        data_prefix='data/amphibian/images/'),
    drop_last=True)
val_dataloader = dict(
        dataset=dict(
        data_root='data/omnibenchmarkv2/',
        ann_file='annotation/amphibian/meta/val.txt',
        data_prefix='data/amphibian/images/'),
    drop_last=False)
test_dataloader = dict(
        dataset=dict(
        data_root='data/omnibenchmarkv2/',
        ann_file='annotation/amphibian/meta/test.txt',
        data_prefix='data/amphibian/images/'),
    drop_last=False)
