...
train_dataloader = dict(batch_size=512,     
    dataset=dict(
        ...
        ann_file='annotation/aquatic_vertebrate/meta/train.txt',
        data_prefix='data/aquatic_vertebrate/images/'),
    drop_last=True)
val_dataloader = dict(
        dataset=dict(
        data_root='data/omnibenchmarkv2/',
        ann_file='annotation/aquatic_vertebrate/meta/val.txt',
        data_prefix='data/aquatic_vertebrate/images/'),
    drop_last=False)
test_dataloader = dict(
        dataset=dict(
        data_root='data/omnibenchmarkv2/',
        ann_file='annotation/aquatic_vertebrate/meta/test.txt',
        data_prefix='data/aquatic_vertebrate/images/'),
    drop_last=False)
