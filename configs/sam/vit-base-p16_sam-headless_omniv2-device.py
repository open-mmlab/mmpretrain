...
train_dataloader = dict(batch_size=2048,     
    dataset=dict(
        ...
        ann_file='annotation/device/meta/train.txt',
        data_prefix='data/device/images/'),
    drop_last=True)
val_dataloader = dict(
        dataset=dict(
        data_root='data/omnibenchmarkv2/',
        ann_file='annotation/device/meta/val.txt',
        data_prefix='data/device/images/'),
    drop_last=False)
test_dataloader = dict(
        dataset=dict(
        data_root='data/omnibenchmarkv2/',
        ann_file='annotation/device/meta/test.txt',
        data_prefix='data/device/images/'),
    drop_last=False)
