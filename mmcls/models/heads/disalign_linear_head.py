...
class DisAlignLinear(torch.nn.Linear):
    ...
    def forward(self, input: torch.tensor):
        logit_before = nn.functional.linear(input, self.weight, self.bias)
...
class DisAlignLinearClsHead(ClsHead):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(DisAlignLinearClsHead, self).__init__(
