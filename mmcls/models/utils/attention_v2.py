...
class WindowMSA_v2(BaseModule):
    ...
    def __init__(self,
        ...
        # log
        indexes = torch.arange(self.window_size)
    ...
    def init_weights(self):
        super(WindowMSA_v2, self).init_weights()
...
class ShiftWindowMSA_v2(BaseModule):
    ...
    def __init__(self,
        ...
        if input_resolution is not None or auto_pad is not None:
            warnings.warn(
                'The ShiftWindowMSA_v2 in new version has supported auto padding '
    ...
    def get_attn_mask(hw_shape, window_size, shift_size, device=None):
        if shift_size > 0:
            ...
            mask_windows = ShiftWindowMSA_v2.window_partition(
