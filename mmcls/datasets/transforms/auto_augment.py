...
RANDAUG_POLICIES = {
    ...
    'timm_increasing': [
        ...
        dict(type='mmcls.Rotate', magnitude_range=(0, 30)),
        dict(type='mmcls.Posterize', magnitude_range=(4, 0)),
        dict(type='mmcls.Solarize', magnitude_range=(256, 0)),
        dict(type='mmcls.SolarizeAdd', magnitude_range=(0, 110)),
        dict(type='mmcls.ColorTransform', magnitude_range=(0, 0.9)),
        dict(type='mmcls.Contrast', magnitude_range=(0, 0.9)),
        dict(type='mmcls.Brightness', magnitude_range=(0, 0.9)),
        dict(type='mmcls.Sharpness', magnitude_range=(0, 0.9)),
        dict(type='mmcls.Shear', magnitude_range=(0, 0.3), direction='horizontal'),
        dict(type='mmcls.Shear', magnitude_range=(0, 0.3), direction='vertical'),
        dict(type='mmcls.Translate', magnitude_range=(0, 0.45), direction='horizontal'),
        dict(type='mmcls.Translate', magnitude_range=(0, 0.45), direction='vertical'),
    ],
}
