...
class SwitchTrainAugHook(Hook):
    ...
    def before_train(self, runner) -> None:
        ...
        Args:
            runner (Runner): The runner of the training, validation or testing
                process.
        """
        # if this hook is the latest switch hook obj in the previously unfinished 
        # tasks, then do the switch process before train
    ...
    def _is_lastest_switch_hook(self, runner):
        """a helper function to judge if this hook is the latest processed switch 
        hooks with the same class name in a runner."""
